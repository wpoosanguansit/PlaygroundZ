...
class AgentSpec extends Specification {
  ...
  def shouldHaveFoundH = {
    val state      = processInputsZ("G", "B", "#", "#", "F")(initial)
    println(initial)
    val result     = runtime.unsafeRun(state)
    println(result)
    val state1     = processInputsZ("B", "#", "G", "A", "C")(result)
    val result1    = runtime.unsafeRun(state1)
    println(result1)
    val state2     = processInputsZ("A", "H", "#", "#", "B")(result1)
    val result2    = runtime.unsafeRun(state2)
    println(result2)
    val state3     = processInputsZ("H", "#", "A", "#", "#")(result2)
  ...
  def shouldHaveEnded = {
    ...
    val result3    = runtime.unsafeRun(state3)
    println(result3)
    val state4     = processInputsZ("A", "H", "#", "#", "B")(result3)
